...
- Day 1 Report: Use `docs/submissions/day1_report.md` (built from `research/architecture_strategy.md` and `research/research_summary.md`).
- Day 2 Repo: Push this repo with commit progression in logical phases.
- Day 2 Loom: Use `docs/submissions/day2_loom_script.md` as the recording script.
- Final checklist: `docs/submissions/final_submission_checklist.md`.
- Submission links form: `docs/submissions/submission_links.md`.
